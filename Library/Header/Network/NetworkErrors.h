...
constexpr int EXIT_WSAStartup =			100;
constexpr int EXIT_WSACleanup =			101;
constexpr int EXIT_socket =				102;
constexpr int EXIT_closesocket =		103;
constexpr int EXIT_bind =				104;
constexpr int EXIT_listen =				105;
